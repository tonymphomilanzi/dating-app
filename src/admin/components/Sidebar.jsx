...
const Sidebar = ({ open, setOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-gray-800
      ...
      >
        ...
        {/* Logout */}
        <div className="shrink-0 px-3 pb-6 pt-4 border-t border-gray-800 mt-4">
          <button
            onClick={logout}
            className="group flex items-center gap-3 w-full px-3 py-2.5 text-sm
              font-medium text-gray-400 rounded-lg hover:bg-red-500/10
              hover:text-red-400 border border-transparent hover:border-red-500/20
              transition-all duration-150"
          >
